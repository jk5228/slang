...
ws = re.compile('\s+')
pairs = [('}', re.compile(re.escape('}'))),('||', re.compile(re.escape('||'))),('{', re.compile(re.escape('{'))),('while', re.compile(re.escape('while'))),('return', re.compile(re.escape('return'))),('in', re.compile(re.escape('in'))),('if', re.compile(re.escape('if'))),('for', re.compile(re.escape('for'))),('else', re.compile(re.escape('else'))),('def', re.compile(re.escape('def'))),('break', re.compile(re.escape('break'))),(']', re.compile(re.escape(']'))),('[', re.compile(re.escape('['))),('>', re.compile(re.escape('>'))),('==', re.compile(re.escape('=='))),('=', re.compile(re.escape('='))),('<', re.compile(re.escape('<'))),(';', re.compile(re.escape(';'))),('/', re.compile(re.escape('/'))),('-', re.compile(re.escape('-'))),(',', re.compile(re.escape(','))),('+', re.compile(re.escape('+'))),('*', re.compile(re.escape('*'))),(')', re.compile(re.escape(')'))),('(', re.compile(re.escape('('))),('&&', re.compile(re.escape('&&'))),('%', re.compile(re.escape('%'))),('!', re.compile(re.escape('!'))),('str', re.compile('"(?P<val>[^"]*)"')),('num', re.compile('-?\d+')),('id', re.compile('[A-Za-z]+'))]
