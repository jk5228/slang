...
rules = defaultdict(list, {'arrAcc':[['id','[','exp',']']],'line':[['exp'],['break'],['retStm']],'prog':[['stm*']],'logExp':[['lOp1','exp'],['(','exp',')','l2op','exp']],'id*':[[],['id+']],'arithExp':[['(','exp',')','aOp2','exp']],'prim':[['num'],['str'],['id']],'lOp1':[['!']],'arrExp':[['{','expLst','}']],'exp+':[['exp'],['exp',',','exp+']],'block':[['funBlk'],['ifBlk'],['whileBlk'],['forBlk']],'stm':[['line',';'],['block']],'ifBlk':[['if','(','exp',')','{','stmLst','}','else','{','stmLst','}']],'exp*':[[],['exp+']],'whileBlk':[['while','(','exp',')','{','stmLst','}']],'exp':[['(','exp',')'],['prim'],['assign'],['arrAcc'],['funExp'],['arrExp'],['arithExp'],['logExp']],'aOp2':[['+'],['-'],['*'],['/'],['%']],'expLst':[['exp*']],'stm*':[[],['stm+']],'retStm':[['return'],['return','exp']],'stmLst':[['stm*']],'forBlk':[['for','(','id','in','exp',')','{','stmLst','}']],'stm+':[['stm'],['stm','stm*']],'idLst':[['id*']],'funExp':[['id','(','expLst',')']],'lOp2':[['&&'],['||'],['=='],['>'],['<']],'funBlk':[['def','id','(','idLst',')','{','stmLst','}']],'assign':[['id','=','exp'],['arrAcc','=','exp']],'id+':[['id'],['id',',','id+']]})
