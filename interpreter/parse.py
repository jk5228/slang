...
rules = defaultdict(list, {'ifBlk':[['if','(','exp',')','{','stmLst','}','else','{','stmLst','}']],'id+':[['id'],['id',',','id+']],'block':[['funBlk'],['ifBlk'],['whileBlk'],['forBlk']],'funExp':[['id','(','expLst',')']],'stm':[['line',';'],['block']],'aOp2':[['+'],['-'],['*'],['/']],'line':[['exp'],['assign'],['break'],['return'],['return','exp']],'exp':[['(','exp',')'],['prim'],['arrAcc'],['funExp'],['arrExp'],['arithExp'],['logExp']],'idLst':[['id*']],'whileBlk':[['while','(','exp',')','{','stmLst','}']],'prog':[['stm*']],'stm+':[['stm'],['stm','stm*']],'id*':[[],['id+']],'assign':[['id','=','exp'],['arrAcc','=','exp']],'expLst':[['exp*']],'stm*':[[],['stm+']],'arithExp':[['(','exp',')','aOp2','exp']],'exp*':[[],['exp+']],'funBlk':[['def','id','(','idLst',')','{','stmLst','}']],'arrAcc':[['id','[','exp',']']],'lOp1':[['!']],'logExp':[['lOp1','exp'],['(','exp',')','l2op','exp']],'stmLst':[['stm*']],'prim':[['num'],['str'],['id']],'lOp2':[['&&'],['||'],['=='],['>'],['<']],'forBlk':[['for','(','id','in','exp',')','{','stmLst','}']],'arrExp':[['{','expLst','}']],'exp+':[['exp'],['exp',',','exp+']]})
