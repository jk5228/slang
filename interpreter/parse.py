...
rules = defaultdict(list, {'stm+':[['stm'],['stm','stm*']],'exp*':[[],['exp+']],'retStm':[['return'],['return','exp']],'forBlk':[['for','(','id','in','exp',')','{','stmLst','}']],'prog':[['stm*']],'stmLst':[['stm*']],'exp+':[['exp'],['exp',',','exp+']],'stm':[['line',';'],['block']],'prim':[['num'],['str'],['id']],'arrExp':[['{','expLst','}']],'expLst':[['exp*']],'lOp2':[['&&'],['||'],['=='],['>'],['<']],'arrAcc':[['id','[','exp',']']],'whileBlk':[['while','(','exp',')','{','stmLst','}']],'ifBlk':[['if','(','exp',')','{','stmLst','}','else','{','stmLst','}']],'arithExp':[['(','exp',')','aOp2','exp']],'line':[['exp'],['break'],['retStm']],'funBlk':[['def','id','(','idLst',')','{','stmLst','}']],'funExp':[['id','(','expLst',')']],'id*':[[],['id+']],'stm*':[[],['stm+']],'id+':[['id'],['id',',','id+']],'block':[['funBlk'],['ifBlk'],['whileBlk'],['forBlk']],'logExp':[['lOp1','exp'],['(','exp',')','l2op','exp']],'aOp2':[['+'],['-'],['*'],['/'],['%']],'exp':[['(','exp',')'],['prim'],['assign'],['arrAcc'],['funExp'],['arrExp'],['arithExp'],['logExp']],'lOp1':[['!']],'idLst':[['id*']],'assign':[['id','=','exp'],['arrAcc','=','exp']]})
